                ...
                <div class="error" style="padding: 15px;">
                  ...
                  ?>                 
                        ...
                        <div class="form-group">
                            <input type="text" name="email" class="form-control" placeholder="Enter email please" required="required">
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" class="form-control" placeholder="Enter password please" required="required">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-outline-info btn-sm" href="reg.php"> CREATE AN ACCOUNT </a> </span>
                        </div>
                    </div>
                </div>
            </div>
